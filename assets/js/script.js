...
function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`Awwwww.... you answered ${userAnswer}. The correct anwer was ${calculateAnswer[0]}!`);
...
/**
 * Get the operand (the number) and the operator (plus, minus etc)
 * directly from the DOM, and return the correct answe.
 */
